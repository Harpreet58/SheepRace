...
namespace SheepRace
{
    public partial class SheepRace : Form
    {
        ...
        public void Punters()
        {
            ...
            myPunters[1].MyLabel = lblHarpreet;
            myPunters[1].MyRadioButton = rbHarpreet;
        ...
        public void BettorBroke() // Checks to see if anyone is broke and cannot continue and update label and blank out radio button
        {
            ...
            if (myPunters[1].Cash <= 0)//Harpreet
            {
                lblHarpreet.Text = "Harpreet is now broke and cannot continue betting";
                rbHarpreet.Enabled = false;
            }
        ...
        private void rbHarpreet_CheckedChanged(object sender, EventArgs e)
        {
            //Show that Harpreet is betting in the bettor label
        ...
        private void btnRace_Click(object sender, EventArgs e)
        {
            ...
            if (myPunters[1].Cash < udBoxBet.Value && rbHarpreet.Enabled)
            {
                MessageBox.Show("Sorry but Harpreet does not have enough cash to proceed.");
                timer1.Enabled = false;
            }
        ...
        public void btnLockIn_Click(object sender, EventArgs e) // Unlock the Race Button and check bet amount is not more than cash
        {
            try
            {
                ...
                {
                    MessageBox.Show("Harpreet does not have enough to proceed");
                    btnRace.Enabled = false;
                }
